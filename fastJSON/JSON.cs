                ...
                if ((pi.Flags & (myPropInfoFlags.Filled | myPropInfoFlags.CanWrite)) != 0)
                {
                    ...
                    if (v != null)
                    {
                        ...
                        switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.String: oset = v.ToString(); break;//(string)v; break;
                            ...
                            default:
                                {
                                    ...
                                    else if (pi.IsClass && v is Dictionary<string, object>)
                                    {
                                        ...
                                        else if (pi.propertysetter != null)
                                        {
                                            oset = ParseDictionary((Dictionary<string, object>)v, globaltypes, pi.pt, pi.propertygetter(o, null));
                                        }
                                    }
