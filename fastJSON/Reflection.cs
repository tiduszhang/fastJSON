...
namespace fastJSON
{
    internal struct Getters
    {
        ...
        public Reflection.GenericPropertyGetter PropertyGetter;
    ...
    internal struct myPropInfo
    {
        ...
        public Reflection.GenericPropertySetter propertysetter;
        public Reflection.GenericPropertyGetter propertygetter;
    ...
    internal sealed class Reflection
    {
        ...
        internal delegate void GenericPropertySetter(object target, object value, object[] index);
        internal delegate object GenericGetter(object obj);
        internal delegate object GenericPropertyGetter(object obj, object[] index);
        ...
        public Dictionary<string, myPropInfo> Getproperties(Type type, string typename, bool IgnoreCaseOnDeserialize, bool customType)
        {
            ...
            //else
            {
                ...
                foreach (PropertyInfo p in pr)
                {
                    ...
                    d.propertysetter = p.SetValue; //Reflection.CreateSetMethod(type, p);
                    d.propertygetter = p.GetValue; //Reflection.CreateGetMethod(type, p);
                ...
                foreach (FieldInfo f in fi)
                {
                    ...
                    d.setter = f.SetValue;// Reflection.CreateSetField(type, f);
                    d.getter = f.GetValue;// Reflection.CreateGetField(type, f);
                    if (IgnoreCaseOnDeserialize)
        ...
        internal Getters[] GetGetters(Type type, JSONParameters param)
        {
            ...
            foreach (PropertyInfo p in props)
            {
                ...
                GenericPropertyGetter g = p.GetValue; //CreateGetMethod(type, p);
                if (g != null)
                    getters.Add(new Getters { PropertyGetter = g, Name = p.Name });
            }
